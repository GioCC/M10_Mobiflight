...
typedef void (*GBcallback)(ButtonGrp*);
...
public:
    ...
    ButtonGrp(  uint8_t pin,
                char    *name,
                GBcallback  OnKeyPress      = NULL,
                GBcallback  OnKeyRelease    = NULL,
                GBcallback  OnKeyLong       = NULL,
                uint8_t     hasRepeat       = 0,
    ...
    ButtonGrp *callbacks(GBcallback OnPress, GBcallback OnRelease=NULL, GBcallback OnLong=NULL)
    ...
    void    setRepeat(uint8_t r)         __attribute__((always_inline))  {if(r) {flags |= F_hasRepeat;} else {flags &= ~F_hasRepeat;} }

    void    setOnPress(GBcallback f)     __attribute__((always_inline))  {_OnPress = (*f);}
    void    setOnRelease(GBcallback f)   __attribute__((always_inline))  {_OnRelease =    (*f);}
    void    setOnLong(GBcallback f)      __attribute__((always_inline))  {_OnLong =  (*f);}
